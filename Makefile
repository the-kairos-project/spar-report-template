...
help:
	...
	@echo "  make               - Build main template (default)"
	@echo "  make example       - Build example report"
	@echo "  make watch         - Watch mode for main template"
	@echo "  make example-watch - Watch mode for example report"
	@echo "  make clean         - Remove auxiliary files (both files)"
