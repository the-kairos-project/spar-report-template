...
% Select depending on whether this is for a midterm report, a final report or for an arXiv submission.
...
\author{
  ...
  % Optional: Add institution/affiliation (mostly useful if/when you plan to turn this into a paper):
  % \\
  % Your Institution
